            ...
            <div className="panel panel-success" >
                ...
                <div className="panel-footer" >
                    <div className="clearfix" >
                        <button className="btn btn-success btn-xs pull-right" onClick={() => this.props.handleDelete(this.props.fruit.id)}>Delete</button>
                        <button className="btn btn-info btn-xs" onClick={() => this.handleEdit()}>{this.state.editable? 'Submit' : 'Edit'}</button>
                    </div>
                </div>
            </div>
        )
