...
RSpec.describe "user_educations/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit user_education form" do
    render

    assert_select "form[action=?][method=?]", user_education_path(@user_education), "post" do
