...
RSpec.describe "user_experiences/new", type: :view do
  before(:each) do
    assign(:user_experience, UserExperience.new(
      :user => nil,
  ...
  it "renders new user_experience form" do
    render

    assert_select "form[action=?][method=?]", user_experiences_path, "post" do
